...
public class Locadora {
    ...
    public static int exibirEscolhas(){
        ...
        System.out.println("2.  Registrar filmes");
        System.out.println("3.  Registrar empréstimos");
        System.out.println("4.  Editar clientes");
        System.out.println("5.  Editar filmes");
        System.out.println("6.  Registrar devoluções");
        System.out.println("7.  Editar empréstimos");
